    ...
    public DC_Moter() {
        ...
        slider1.addChangeListener(new ChangeListener() {
            ...
            public void stateChanged(ChangeEvent e) {
                RXTX.SerialPort_Put_String("s".getBytes());
                RXTX.SerialPort_Put_String((String.valueOf(100-slider1.getValue())+(char)13).getBytes());
        ...
        button1.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                RXTX.SerialPort_Put_String("r".getBytes());
                RXTX.SerialPort_Put_String((String.valueOf((int)(Double.valueOf( a0TextField.getText())*1.41666666666666666666666))+(char)13).getBytes());
            }
        });
        ...
        逆時針Button.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                RXTX.SerialPort_Put_String("l".getBytes());
                RXTX.SerialPort_Put_String((String.valueOf((int)(Double.valueOf( a0TextField.getText())*1.41666666666666666666666))+(char)13).getBytes());
            }
        });
